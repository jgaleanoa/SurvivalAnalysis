...
obtener gráficas estimadas para los hazard de cada grupo basta con fijar
valores en $x_1$ y evaluar diferentes valores de $t$
...
los tumores puesto que un hazard creciente implica una supervivencia
decreciente.
